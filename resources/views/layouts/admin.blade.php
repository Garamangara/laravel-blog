...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/skgm1booiafe3ouengmzc7c7taw90ge62ucl58mk7yavhu7w/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        tinymce.init({
            selector: '.full-text'
        });
